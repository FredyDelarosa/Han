...
export class TableComponent implements AfterViewInit {
  ...
  fetchPokemons(): void {
    const limit = 15; // Número máximo de Pokémon a mostrar
    const offset = 0; // Comienza desde el primer Pokémon
  
    this.pokeApiService.getPokemons(limit, offset).subscribe((response: any) => {
      ...
      this.dataSource.data = this.pokemons; // Asigna los datos a la tabla
    });
  }
